...
class ComplianceRepo {
    ...
    async getPlaybook(orgId) {
        const { Item } = await this.ddb.getItem(tables_1.Tables.COMPLIANCE, { orgId, sk: (0, keys_1.compliancePlaybookSk)() });
        return Item ?? null;
    }
    async putPlaybook(orgId, tasks, updatedBy) {
        await this.ddb.put(tables_1.Tables.COMPLIANCE, {
            orgId,
    ...
    async listTasks(orgId, userId) {
        ...
        const { Items } = await this.ddb.query({
            TableName: tables_1.Tables.COMPLIANCE,
    ...
    async updateTask(orgId, userId, taskId, updates) {
        ...
        await this.ddb.update(tables_1.Tables.COMPLIANCE, { orgId, sk: (0, keys_1.complianceTaskSk)(userId, taskId) }, {
