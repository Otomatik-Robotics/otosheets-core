...
export class RoutingTimeEntryRepo implements ITimeEntryRepo {
    ...
    async listTimeEntries(o: string, u: string, opts?: { uninvoiced?: boolean; businessProfileId?: string }) { const r = await resolveRoute(DOMAIN); return this.rd('listTimeEntries', () => this.pick(r).listTimeEntries(o, u, opts), () => this.pg.listTimeEntries(o, u, opts), r); }
