...
export const InvoiceBaseSchema = z.object({
    ...
    convertedInvoiceId: z.string().nullish(),
    sourceQuoteId: z.string().nullish(),
    quoteAcceptedAt: z.string().nullish(),
    quoteAcceptedEventId: z.string().nullish(),
    quoteAcceptancePublishedAt: z.string().nullish(),
