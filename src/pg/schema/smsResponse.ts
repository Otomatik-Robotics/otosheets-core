import { pgTable, text, integer, jsonb, index, primaryKey } from 'drizzle-orm/pg-core';
...
}, t => [index('sms_response_profile_idx').on(t.orgId, t.businessProfileId), index('sms_response_pending_idx').on(t.publishedAt, t.receivedAt)]);
