...
export const invoices = pgTable('invoices', {
    ...
    quoteAcceptanceTokenHashes: jsonb('quote_acceptance_token_hashes').$type<string[]>(),
    convertedInvoiceId: text('converted_invoice_id'),
    sourceQuoteId: text('source_quote_id'),
    quoteAcceptedAt: text('quote_accepted_at'),
    quoteAcceptedEventId: text('quote_accepted_event_id'),
    quoteAcceptancePublishedAt: text('quote_acceptance_published_at'),
